...
> ⚠ **ВАЖНО!** Для DOTS разрабывается отдельная версия данного плагина с поддержкой BlobAsset и Burst. Но вы можете использовать и эту версию, если вас устраивает размещение BT как desicion-layer на main-thread и его тик раз в N секунд.
